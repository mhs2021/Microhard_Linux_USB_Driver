...
/* Microhard products */
#define MICROHARD_VENDOR_ID			    0x1f94
#define MICROHARD_PRODUCT_SQ_CAT4		0x0125
...
static const struct option_blacklist_info microhard_if_blacklist = {
  .reserved = BIT(4) | BIT(5) | BIT(6),
};
...
static const struct usb_device_id option_ids[] = {
  ...
  { USB_DEVICE(QUECTEL_VENDOR_ID, QUECTEL_PRODUCT_EG91),
    ...
    { USB_DEVICE(MICROHARD_VENDOR_ID, MICROHARD_PRODUCT_SQ_CAT4),   /* Microhard LTESQ-CAT4 */
	  .driver_info = (kernel_ulong_t)&microhard_if_blacklist },
	{ } /* Terminating entry */
};
...
//Quectel EC25&EC21&EG91&EG95&EG06&EP06&EM06&BG96/AG35's interface 4 can be used as USB network device
  ...
  #if 1 //Added by Microhard
  //Microhard LTESQ-CAT4's interface 4 can be used as USB network device
  if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1F94)
    && serial->interface->cur_altsetting->desc.bInterfaceNumber >= 4)
  return -ENODEV;
  #endif
